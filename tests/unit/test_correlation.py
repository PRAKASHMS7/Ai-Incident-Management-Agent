...
@patch("src.core.correlation.redis_manager")
@patch("src.core.correlation.neo4j_manager")
def test_correlate_merge_same_service(mock_neo4j, mock_redis, base_alert, active_incident):
    """
...
@patch("src.core.correlation.redis_manager")
@patch("src.core.correlation.neo4j_manager")
def test_correlate_merge_dependency_graph(mock_neo4j, mock_redis, base_alert, active_incident):
    """
    ...
    assert incident_id == active_incident.id
    mock_neo4j.check_dependency_path.assert_called_once_with("api-gateway", ["payment-service"])
...
@patch("src.core.correlation.redis_manager")
@patch("src.core.correlation.neo4j_manager")
def test_correlate_time_window_expiration(mock_neo4j, mock_redis, base_alert, active_incident):
    """
